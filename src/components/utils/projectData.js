...
import Puppeteer from "../../assets/project_images/puppeteer.png";
import Coming from "../../assets/project_images/coming.jpg";

const projectData = [
  {
    title: "React Screenshot App",
    snapShot: Puppeteer,
    desc:
      "A React app that helps users crawl multiple screenshots of websites concurrently. The concepts and technologies used: HTML/ CSS, Javascript, Nodejs, React, Puppeteer, Async programing",
    demoURL: "https://react-screenshot-app.herokuapp.com/",
    githubURL: "https://github.com/saikitjk/react-screenshot-app",
    category: [
      "html",
      "css",
      "Javascript",
  ...
  },
  {
    ...
    desc:
      "A React app that provides you a list of employees with their avators, names, emails, phone numbers, DOBs and ages. The concepts and technologies used: HTML/ CSS, Javascript, Nodejs, React, Boostrap",
  ...
  },
  {
    ...
    category: ["html", "css", "Javascript", "jQuery", "Frontend"],
  },
  {
    title: "Day Planner",
    snapShot: DayPlan,
  ...
  },
  {
    ...
    category: ["html", "css", "Javascript", "jQuery", "API", "Frontend"],
  },
  {
  ...
  },
  {
    ...
    category: ["html", "css", "Javascript", "Nodejs", "Backend"],
  },
  {
    title: "Note Taker",
    snapShot: NoteTaker,
    desc:
      "A note taking application that allows use to manage their notes. The concepts and technologies used: HTML/ CSS/ Javascript/ jQuery/ NodeJS/ Expressjs",
    demoURL: "https://notestaker-jk.herokuapp.com/",
    githubURL: "https://github.com/saikitjk/NoteTaker",
    category: ["html", "css", "Javascript", "Nodejs", "Expressjs", "Frontend"],
  },
  {
